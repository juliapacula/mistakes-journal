...
namespace Mistakes.Journal.Api.Migrations
{
    ...
    [Migration("20211212205603_AddAllowNewsletterToUser")]
    partial class AddAllowNewsletterToUser
    {
            ...
            modelBuilder.Entity("Mistakes.Journal.Api.Logic.Identity.Models.MistakesJournalUser", b =>
                {
                    ...
                    b.Property<bool>("AgreeToNewsletter")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("agree_to_newsletter")
                    ...
                    b.Property<DateTime?>("LastLoggingIn")
                        .HasColumnName("last_logging_in")
                    ...
                    b.Property<int>("LoggedDaysCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("logged_days_count")
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
